...
p("We have connected to your MongoDB server.")
...
# Add extra info
p("Adding s/c/q info to the database...")
col_subject.insert_many(zip_subject(), False)
col_class.insert_many(zip_class(), False)
col_question.insert_many(zip_question(), False)
p("Finished!")
